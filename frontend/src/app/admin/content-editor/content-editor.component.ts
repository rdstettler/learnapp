...
export class ContentEditorComponent implements OnInit {
    ...
    readonly defaultPrompts: Record<string, string> = {
        ...
        rechtschreibung: 'WICHTIG: Erstelle Lückentext Bsp. mit markierter korrekter Form: "Das K[*i/ie]nd". Erstelle Zuordnen Bsp. mit "word": "K__nd", "options": ["i","ie"], "correct": "i", "rule": "i/ie". BEIDES für Mode "luecken" oder "zuordnen" setzen.',
    };
